...
from utils.lavalink_make_node import connect_node
...
command_prefix = ['freewifi ', 'fw ', 'freewifi　', 'fw　']
...
lavahost = os.getenv('LAVA_HOST')
lavapass = os.getenv('LAVA_PASS')
    ...
    async def after_ready(self):
        ...
        if not self.initialized:
            ...
            for guild in self.guilds:
                guild_id = guild.id
                await connect_node(self, guild_id)
